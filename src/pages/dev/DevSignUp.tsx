...
export default function DevSignUp() {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            const redirectUrl = `${window.location.origin}/dev/login`;
            ...
            if (authError) {
                if (authError.message.includes("already registered") || authError.message.includes("User already registered")) {
                    toast({
                        ...
                        description: "มีบัญชีของคุณในระบบอยู่ก่อนแล้ว กรุณากลับไปที่หน้าเข้าสู่ระบบ (Login) ด้วยอีเมลและรหัสผ่านเดิม หากติดปัญหาให้ติดต่อ Dev",
                        variant: "default",
                    });
                ...
                <CardContent>
                    ...
                    <div className="mt-6 space-y-3 text-center text-sm">
                        <p className="text-muted-foreground">
                            มีบัญชีอยู่แล้ว?{" "}
                            <Link to="/dev/login" className="text-primary hover:underline font-medium">
                                เข้าสู่ระบบ
                            </Link>
                        </p>
                        <p className="text-muted-foreground">
