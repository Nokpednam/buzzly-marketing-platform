        ...
        `)
            ...
            if (!employeeData) {
                ...
                if (!roleData || roleData.length === 0) {
                    // Regular customer - not allowed on dev login
                    await auditAuth.loginFailed(email, "Not a dev or employee");
                    toast({
                        title: "ไม่มีสิทธิ์เข้าใช้งาน",
                        description: "คุณไม่ใช่ dev หรือ employee กรุณาใช้หน้า login สำหรับลูกค้า",
                        variant: "destructive",
                    });
            ...
            if (employeeData.approval_status === "pending") {
                ...
                toast({
                    title: "รอการอนุมัติ",
                    description: "บัญชีของคุณอยู่ระหว่างรอการอนุมัติจาก Dev",
                    variant: "destructive",
                });
                return;
            }
                ...
                <CardContent>
                    ...
                    <div className="mt-6 space-y-3 text-center text-sm">
                        <p className="text-muted-foreground">
                            ยังไม่มีบัญชี?{" "}
                            <Link to="/dev/signup" className="text-primary hover:underline font-medium">
                                สมัครเป็น Employee
                            </Link>
                        </p>
                        <p className="text-muted-foreground">
