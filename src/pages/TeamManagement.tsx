...
function TeamManagementContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border border-gray-100 rounded-xl shadow-none">
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="outline" className="font-normal text-muted-foreground border-gray-200 capitalize">
      ...
      <Card className="border border-gray-100 rounded-xl shadow-none">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 rounded-xl border border-gray-100 overflow-hidden bg-gray-50/50">
            {(["owner", "admin", "editor", "viewer"] as const).map((role) => {
              ...
              return (
                <div
                  key={role}
                  className="border-r border-b border-gray-100 [&:nth-child(2n)]:border-r-0 md:[&:nth-child(2n)]:border-r md:[&:nth-child(4n)]:border-r-0 [&:nth-last-child(-n+2)]:border-b-0 md:[&:nth-last-child(-n+2)]:border-b md:[&:nth-last-child(-n+4)]:border-b-0"
                >
                  <Popover>
                    <PopoverTrigger asChild>
                      <button
                        type="button"
                        className="w-full text-left px-4 py-3 hover:bg-gray-100/80 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset rounded-none"
                      >
                  ...
                  <PopoverContent
                    align="start"
                    className="w-80 p-0 rounded-xl border border-gray-200 shadow-lg"
                  >
      ...
      <Tabs defaultValue="members" className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <TabsList className="inline-flex h-9 items-center rounded-full bg-gray-100 p-1 border border-gray-200 w-fit">
            <TabsTrigger
              value="members"
              className="rounded-full px-4 py-1.5 text-sm font-medium text-muted-foreground data-[state=active]:bg-white data-[state=active]:text-foreground data-[state=active]:shadow-sm data-[state=active]:border data-[state=active]:border-gray-200/80 transition-all"
            >
        ...
        <TabsContent value="members">
          <Card className="border border-gray-100 rounded-xl shadow-none overflow-hidden">
