  ...
  public: {
    Tables: {
      ...
      ad_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_groups_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      ad_personas: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_personas_ad_id_fkey"
            columns: ["ad_id"]
            isOneToOne: false
            referencedRelation: "ads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ad_personas_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: false
      ...
      ads: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ads_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      post_personas: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_personas_persona_id_fkey"
            columns: ["persona_id"]
            isOneToOne: false
            referencedRelation: "customer_personas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "post_personas_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
      ...
      social_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "social_comments_platform_id_fkey"
            columns: ["platform_id"]
            isOneToOne: false
            referencedRelation: "platforms"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "social_comments_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      social_posts: {
        ...
        Relationships: [
          {
            foreignKeyName: "social_posts_ad_group_id_fkey"
            columns: ["ad_group_id"]
            isOneToOne: false
            referencedRelation: "ad_groups"
            referencedColumns: ["id"]
      ...
      sync_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "sync_history_platform_id_fkey"
            columns: ["platform_id"]
            isOneToOne: false
            referencedRelation: "platforms"
            referencedColumns: ["id"]
      ...
      tier_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tier_history_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "customer"
            referencedColumns: ["id"]
