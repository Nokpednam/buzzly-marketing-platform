...
export function useDevAllMembers() {
    return useQuery({
        queryKey: ["dev-all-members"],
        queryFn: async () => {
...
export function useDevAllInvitations() {
    return useQuery({
        queryKey: ["dev-all-invitations"],
        queryFn: async () => {
            const { data, error } = await supabase
...
export function useUpdateMember() {
    ...
    return useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["dev-all-members"] });
...
export function useDeleteInvitation() {
    ...
    return useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["dev-all-invitations"] });
