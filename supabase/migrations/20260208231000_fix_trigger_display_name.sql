-- Fix handle_new_user trigger to match actual profile_customers schema
-- The issue: trigger tries to insert 'display_name' column which doesn't exist
...
BEGIN
    ...
    ELSE
        -- Default customer flow - FIXED: removed display_name column
