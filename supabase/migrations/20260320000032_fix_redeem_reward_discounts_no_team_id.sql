-- ============================================================================
-- Fix: redeem_reward — "column team_id of relation discounts does not exist"
-- Timestamp: 20260320000031
--
-- The discounts table had team_id DROPPED in 20260306000001_platform_discounts_rls.
-- redeem_reward was still inserting team_id, causing FK/column errors.
--
-- Fix: Insert into discounts WITHOUT team_id (platform-level codes only).
-- ============================================================================
...
BEGIN
    ...
    -- Insert into discounts (NO team_id — column was dropped in 20260306000001)
    BEGIN
    ...
    EXCEPTION WHEN OTHERS THEN
        RAISE WARNING 'Could not insert into discounts: %', SQLERRM;
    END;
