-- ============================================================================
-- Migration: handle_new_user — create loyalty_points wallet for new customers
-- Timestamp: 20260320000055
--
-- Problem: New customers don't get loyalty_points on signup. award_loyalty_points
--          auto-creates on first mission, but tier/rewards need the wallet to exist.
--
-- Fix: Add loyalty_points creation to handle_new_user (customer signup path).
-- ============================================================================
