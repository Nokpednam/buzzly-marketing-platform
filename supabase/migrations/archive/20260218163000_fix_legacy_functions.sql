-- Fix legacy functions to use new table names (workspaces, workspace_members)
-- This migration updates functions that were hardcoding 'teams' and 'team_members'

-- 1. Helper Function: Check if user is a member of a team (workspace)
...
-- 2. Helper Function: Check if user can manage a team (workspace)
...
-- 2b. Helper Function: Get user's role in a team (workspace)
...
-- 3. Update handle_new_user to use workspaces and workspace_members
